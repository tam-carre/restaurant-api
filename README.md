...
$ req '/customers' '{"name": "Maria", "email": "maria@gmail.com"}'
HTTP/1.1 200 OK

# What happens if we send invalid data, e.g. typo "email" as "mail"?
$ req '/customers' '{"name": "James", "mail": "james@yahoo.com"}'
...
$ req '/customers' '{"name": "Maria Magdalena", "email": "maria@gmail.com"}'
HTTP/1.1 409 Conflict
{"error":{"status":409,"message":"Another customer has this email address."}}%  

# Let's create our first reservation!
$ req '/reservations' '{"customer": "maria@gmail.com", "restaurantTable": 1, "arrivalDate": "2021-08-30", "arrivalTime": "19:15:00"}'
HTTP/1.1 200 OK

# What happens if you try to reserve with a non-existent customer email?
$ req '/reservations' '{"customer": "non@existent.com", "restaurantTable": 2, "arrivalDate": "2021-08-30", "arrivalTime": "19:15:00"}'
HTTP/1.1 422 Unprocessable Entity
{"error":{"status":422,"message":"No customer with this email address was found."}}% 

# Seating time is 1 hour. What happens when you try to reserve a table that is already occupied?
$ req '/reservations' '{"customer": "maria@gmail.com", "restaurantTable": 1, "arrivalDate": "2021-08-30", "arrivalTime": "20:00:00"}'
HTTP/1.1 409 Conflict
{"error":{"status":409,"message":"This table is not free at this time."}}%

# What about reserving outside the opening hours of 19:00-24:00?
$ req '/reservations' '{"customer": "maria@gmail.com", "restaurantTable": 1, "arrivalDate": "2021-08-30", "arrivalTime": "15:00:00"}'
HTTP/1.1 422 Unprocessable Entity
{"error":{"status":422,"message":"The restaurant is closed at this time."}}%

# What about reserving a non-existent table?
$ req '/reservations' '{"customer": "maria@gmail.com", "restaurantTable": 777, "arrivalDate": "2021-08-30", "arrivalTime": "15:00:00"}'
HTTP/1.1 422 Unprocessable Entity
{"error":{"status":422,"message":"Table 777 does not exist."}}%

# Malformed data?
req '/reservations' '{"customer": "maria@gmail.com", "table": 1, "arrivalDate": "2021-08-30", "arrivalTime": "15:00:00"}'
HTTP/1.1 400 Bad Request
...
$ for ((i=1;i<=5;i++)); do req '/reservations' '{"customer": "maria@gmail.com", "restaurantTable": '$i', "arrivalDate": "2021-08-29", "arrivalTime": "19:00:00"}'; done

# Let's list reservations now.
$ curl -i "http://0.0.0.0:3000/reservations?fromDate=2021-01-01&toDate=2022-12-01" 
HTTP/1.1 200 OK
...
$ curl -i "http://0.0.0.0:3000/reservations?fromDate=2021-01-01&toDate=2022-12-01&limit=2" 
HTTP/1.1 200 OK
...
$ curl -i "http://0.0.0.0:3000/reservations?fromDate=2021-01-01&toDate=2022-12-01&limit=2&offset=2"
HTTP/1.1 200 OK
